    ...
    <main>
        ...
        <div class="col-md-7 col-lg-8">
            <div class="text-right">
                ...
                %>
                <a href="5_logout.jsp" class="btn btn-sm btn-success pull-right">logout</a>
                <%}%>
            </div>
            <br>
            <h4 class="mb-3"><fmt:message key="title"/></h4>
            <form class="needs-validation" novalidate action="./5_processAddBook.jsp" method="post" name="newBook" enctype="multipart/form-data">
                <div class="row g-3">
