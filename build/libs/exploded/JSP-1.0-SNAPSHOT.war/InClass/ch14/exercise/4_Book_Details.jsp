...
<%@ page errorPage="4_exceptionNoBookId.jsp" %>
<html lang="en">
<head>
        ...
        <div class="row align-items-md-stretch">
            <div class="col-md-6">
                ...
                <div class="h-90 p-5 bg-light border rounded-3">
                    ...
                    <form name="addForm" action="./4_addCart.jsp?id=<%=book.getBookId() %>" method="post">
                        <a href="#" class="btn btn-info" onclick="addToCart()">도서 주문&raquo;</a>
                        <a href="./4_cart.jsp" class="btn btn-warning">장바구니&raquo;</a>
                        <a href="./4_Book_Home.jsp" class="btn btn-secondary">도서 목록&raquo;</a>
                    </form>
<%--                    <p> <a href="4_addCart.jsp?id=<%= request.getParameter("id")%>" class="btn btn-secondary" >도서 주문 &raquo</a>--%>
<%--                        <a href="./4_Book_Home.jsp" class="btn btn-secondary">도서 목록 &raquo</a>--%>
                </div>
            </div>
        </div>
