...
<div class="container col-8 alert alert-info">
    ...
    <div>
        ...
        <a href="./4_shippingInfo.jsp?cartId=<%=shipping_cartId %>"class="btn btn-secondary" role="button">이전</a>
        <a href="./4_thankCustomer.jsp" class="btn btn-success" role="button">주문 완료</a>
