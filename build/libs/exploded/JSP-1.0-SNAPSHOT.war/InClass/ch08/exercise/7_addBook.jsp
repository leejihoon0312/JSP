    ...
    <main>
        ...
        <div class="col-md-7 col-lg-8">
            ...
            <form class="needs-validation" novalidate action="./7_processAddBook.jsp" method="post" name="newBook" enctype="multipart/form-data">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" name="name"  id="name" placeholder="상품명" required>
                            <div class="invalid-feedback">
                                must required.
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" name="unitPrice" id="unitPrice" placeholder="가격" required>
                            <div class="invalid-feedback">
                                must required.
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" name="unitsInStock" id="unitsInStock" placeholder="재고 수" required>
                            <div class="invalid-feedback">
                                must required.
                            </div>
                        </div>
                ...
                <button class="w-100 btn btn-primary btn-lg" type="button" onclick="CheckAddBook()">상품 등록</button>
            </form>
        </div>
    </main>
